...
LDR_ID="${LDR_ID:-ev_5}"
EXP_NAME="${EXP_NAME:-mul_loss_detail_gt_temporal_detail_hf}"
...
cd "${ROOT_DIR}"
echo "[train] temporal-detail high-pass residual on GPUs ${GPUS}"
...
"${ACCELERATE_BIN}" launch \
  ...
  mul_loss_fine/finetune_mul_loss_detail_gt_temporal_detail_hf.py \
