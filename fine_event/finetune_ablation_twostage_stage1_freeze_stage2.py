...
def run(cfg: OmegaConf):
    cfg.model.disable_second_stage = True

    cfg.train.two_stage_train_mode = "stage1"
    cfg.train.unfreeze_heads = True
    cfg.train.unfreeze_aggregator_blocks = True
    cfg.train.unfreeze_aggregator_last_blocks = 0

    cfg.loss.pose_weight = 1.0
    ...
    launch(
        cfg,
        exp_name="ablation_twostage_stage1_freeze_stage2",
