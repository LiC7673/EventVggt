...
export GPUS="${GPUS:-4}"
export OUTPUT="${OUTPUT:-exp_f/alternating_geo_detail_first_dual_c_fixed_gpu4}"
export TRAIN_MODULE="paired_token_reliability.train_linear_voxel_alternating_detail_first_fixed"
