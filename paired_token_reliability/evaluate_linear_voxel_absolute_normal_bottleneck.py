"""Evaluator for absolute-event-normal bottleneck checkpoints."""
...
def build_model(checkpoint: Path, _override, device):
    ...
    expected = AbsoluteNormalBottleneckLinearVoxelModel.checkpoint_schema
    ...
    model = AbsoluteNormalBottleneckLinearVoxelModel(
        ...
        normal_bottleneck_warmup_steps=int(getattr(m, "normal_bottleneck_warmup_steps", 2000)),
