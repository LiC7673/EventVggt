"""Evidence test for event cues and GT differential geometry.

This script follows first.md: it does not train a model. It loads our event
dataset, computes event cues and GT geometry differential maps, then reports
correlation/AUC/F1 style evidence that events carry geometry-detail signals.
"""
