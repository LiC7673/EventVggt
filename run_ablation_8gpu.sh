...
SCRIPTS=(
  "finetune_ablation_rgb_coarse.py"
  "finetune_ablation_global_only.py"
  "finetune_ablation_local_only.py"
  "finetune_ablation_global_local.py"
  "finetune_ablation_tokens_4.py"
  "finetune_ablation_tokens_16.py"
  "finetune_ablation_tokens_64.py"
  "finetune_ablation_tokens_256.py"
  "finetune_ablation_event_h16.py"
  "finetune_ablation_event_h8.py"
  "finetune_ablation_event_h4.py"
  "finetune_ablation_event_h2.py"
)
